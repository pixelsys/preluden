...
public final class DataMatrixWriter implements Writer {
  ...
  public BitMatrix encode(String contents, BarcodeFormat format, int width, int height, Map<EncodeHintType,?> hints) {
    ...
    if (hints != null) {
     ...
     if(hints.containsKey(EncodeHintType.GS1_ENCODE) && (Boolean)hints.get(EncodeHintType.GS1_ENCODE) == true){
    	 isGS1 = true;
     }
    ...
    String encoded = HighLevelEncoder.encodeHighLevel(contents, shape, minSize, maxSize, isGS1);
