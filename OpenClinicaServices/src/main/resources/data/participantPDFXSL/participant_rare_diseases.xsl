								...
								<fo:table-row border-style="solid" border-width="1px" border-color="#C7C5C5">
									<fo:table-cell   padding-left="3pt"  padding-top="5pt">
										...
										<fo:block text-align="left" margin-left="10pt" margin-bottom="5pt">
											 	...
											 	<xsl:if test="not(normalize-space(barcodeValue4)='')">
									...
									<fo:table-cell   padding-left="3pt"  padding-top="5pt">
										<fo:block linefeed-treatment="preserve" text-align="left" margin-left="10pt" margin-bottom="2pt"  margin-top="5pt" >
											<xsl:value-of select="barcodeName5" />: <xsl:value-of select="barcodeValue5" />
										</fo:block>										
										<fo:block text-align="left" margin-left="10pt" margin-bottom="5pt">
											 	<xsl:variable name="barcodeFile5" select="barcodeFile5"></xsl:variable>
												<fo:external-graphic   src="{barcodeFile5}" content-width="scale-to-fit"  scaling="uniform"  width="6cm" height="1cm"> </fo:external-graphic>
										</fo:block>											
									</fo:table-cell>
								</fo:table-row>
				    ...
				    <fo:block font-size="10pt" >
						<fo:table table-layout="fixed" >
							...
							<fo:table-body>																					
								...
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="20pt"  margin-bottom="2pt">
								...
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="20pt">
