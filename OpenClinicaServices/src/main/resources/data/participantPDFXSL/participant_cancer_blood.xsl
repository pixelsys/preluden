							...
							<fo:table-body>																					
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="5pt"  margin-bottom="3pt">
								...
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="5pt"  margin-bottom="2pt">
											Sample Tube: <xsl:value-of select="sampleTube2" />
											Sample Type: <xsl:value-of select="sampleType2" />			
										</fo:block>
										<fo:block text-align="left" margin-bottom="5pt">
										 	<xsl:variable name="sampleBarcodeFile2" select="sampleBarcodeFile2"></xsl:variable>
											<fo:external-graphic  src="{sampleBarcodeFile2}" content-width="scale-to-fit"  scaling="uniform"  width="6cm" height="1cm"> </fo:external-graphic>
										</fo:block>
									</fo:table-cell>									
									<fo:table-cell>													
											<fo:block text-align="center" font-size="12pt" font-weight="bold"  color="#BFBBBE" margin-left="20pt" linefeed-treatment="preserve">
								...
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="5pt" margin-bottom="2pt">
											Sample Tube: <xsl:value-of select="sampleTube3" />
											Sample Type: <xsl:value-of select="sampleType3" />			
										</fo:block>
										<fo:block text-align="left" margin-bottom="5pt">
										 	<xsl:variable name="sampleBarcodeFile3" select="sampleBarcodeFile3"></xsl:variable>
											<fo:external-graphic  src="{sampleBarcodeFile3}" content-width="scale-to-fit"  scaling="uniform"  width="6cm" height="1cm"> </fo:external-graphic>
										</fo:block>
									</fo:table-cell>									
									<fo:table-cell>													
											<fo:block text-align="center" font-size="12pt" font-weight="bold"  color="#BFBBBE" margin-left="20pt" linefeed-treatment="preserve">
								...
								<fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
									<fo:table-cell padding-left="5pt"  display-align="after">
										<fo:block linefeed-treatment="preserve" margin-top="5pt">
											Sample Tube: <xsl:value-of select="sampleTube4" />
											Sample Type: <xsl:value-of select="sampleType4" />			
										</fo:block>
										<fo:block text-align="left" margin-bottom="5pt">
										 	<xsl:variable name="sampleBarcodeFile4" select="sampleBarcodeFile4"></xsl:variable>
											<fo:external-graphic  src="{sampleBarcodeFile4}" content-width="scale-to-fit"  scaling="uniform"  width="6cm" height="1cm"> </fo:external-graphic>
										</fo:block>
									</fo:table-cell>									
									<fo:table-cell>													
											<fo:block text-align="center" font-size="12pt" font-weight="bold"  color="#BFBBBE" margin-left="20pt" linefeed-treatment="preserve">
                               ...
                               <fo:table-row border-style="solid" border-width="1pt" border-color="#C7C5C5">
                                    <fo:table-cell padding-left="5pt"  display-align="after">
                                        <fo:block linefeed-treatment="preserve" margin-top="5pt">
                                            Sample Tube: <xsl:value-of select="sampleTube5" />
                                            Sample Type: <xsl:value-of select="sampleType5" />          
                                        </fo:block>
                                        <fo:block text-align="left" margin-bottom="5pt">
                                            <xsl:variable name="sampleBarcodeFile5" select="sampleBarcodeFile5"></xsl:variable>
                                            <fo:external-graphic  src="{sampleBarcodeFile5}" content-width="scale-to-fit"  scaling="uniform"  width="6cm" height="1cm"> </fo:external-graphic>
                                        </fo:block>
                                    </fo:table-cell>                                    
                                    <fo:table-cell>                                                 
                                            <fo:block text-align="center" font-size="12pt" font-weight="bold"  color="#BFBBBE" margin-left="20pt" linefeed-treatment="preserve">
