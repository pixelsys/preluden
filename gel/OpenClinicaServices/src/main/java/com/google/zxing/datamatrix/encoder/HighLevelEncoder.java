...
public final class HighLevelEncoder {
  ...
  public static String encodeHighLevel(String msg,
    ...
    /**
     * Added by Soheil 
     * soheil.saifipour@ndm.ox.ac.uk 22.01.2015
     * if it is a GS1 string, then 00 is added to the beginning for the string
     * and now we need to add 232 to the beginning of the codewords
     * Having (char)232 which is FNC(1) at the beginning of the codewords mean that it is a GS1 and
     * the bar-code scanner will detect that
     * for <GS> in between the sections, the user should have inserted the (char)29 in the main input string
     */
    if(isGS1){
    	codewords.setCharAt(0, (char)232);
    }
