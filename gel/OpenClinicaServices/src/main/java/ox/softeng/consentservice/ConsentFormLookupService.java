 ...
 */
@WebServlet("/lookupServices/ConsentForm")
public class ConsentFormLookupService extends HttpServlet {
    private static final long serialVersionUID = 1L;

    static final Logger LOG = LoggerFactory.getLogger(ConsentFormLookupService.class);
    
    public ConsentFormLookupService() {
        super();
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOG.debug("ConsentForm Lookup requested...");
        ...
        LOG.debug("ConsentForm Lookup responded");
        return;
    }
